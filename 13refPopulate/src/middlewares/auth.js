...
const userAuth= async (req,res,next)=>{
    ...
    console.log("user auth mein next se pehle")
    next();
    console.log("user auth mein next ke baad")
    /// USE OF NEXT:::: ROUTE GOES ITNO THIS FIRST AND IF EVERYTHING FINE, IT LETS IT PASS THROUGH
