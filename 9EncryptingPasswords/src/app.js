...
app.post('/login', async (req,res)=>{
    try{
        ...
        validator.isEmail(emailId)          //valid email syntax check
       ...
       const isPaasswordValid= await bcrypt.compare(password,user.password)           //("plain text pass", "original saved hash") => return bool
if(isPaasswordValid){
